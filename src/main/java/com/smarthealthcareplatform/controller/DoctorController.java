...
public class DoctorController {
    ...
    // BUG-09: Duyệt lịch hẹn — truyền email bác sĩ để xác minh quyền sở hữu
    ...
    // BUG-09: Tạo bệnh án — truyền email bác sĩ để xác minh quyền sở hữu
    ...
    public ResponseEntity<String> createMedicalRecord(@RequestBody CreateMedicalRecordRequest request, Authentication authentication) {
        ...
        return ResponseEntity.ok("Ghi nhận bệnh án và đơn thuốc thành công.");
    }
}
